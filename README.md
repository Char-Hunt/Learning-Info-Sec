...
My name is Char! As a [Cybersecurity Analyst and IT Consultant](https://www.charhunt.org) I'm leveraging my several years of experience in technology to provide solutions for enterprise environments. I have a strong background in IT network infrastructure and IT Technical Support, IT Services Management, and core business operations, as well as coursework and certifications in CISSP (in progress), CC, Security+, A+, Network+, and GRC. 
